...
class UserListResource(Resource):
    def post(self):
        ...
        text = 'Hi, Thanks for using SmileCook! Please confirm your registration by clicking on the link: {}'.format(
            link)
...
class UserActivateResource(Resource):
    ...
    def get(self, token):
        ...
        if user.is_active is True:
            return {'message': 'The user is already active'}, HTTPStatus.BAD_REQUEST
